...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2017 at 03:37 PM
...
CREATE TABLE `tasks` (
  ...
  `Description` text NOT NULL,
  `Tag` text NOT NULL,
  `Claimed_By` bigint(20) NOT NULL DEFAULT '0',
...
(1, 15183796, '2017-03-03 00:00:00', '0000-00-00', 'Assignment', 'Managing A Legal Accounts System', 2500, 2459, 6, 'doc', '2017-04-14', '17:30:00', 'Assignment looking at how legal accounts are managed - therefore contributing to calculating legal fees etc', 'Legal Fees\r\nManaging Accounts', 0, 0, 0),
(2, 16115224, '2017-03-03 00:00:00', '0000-00-00', 'Assignment', 'Implications of using Epidural during labour', 2500, 2573, 6, 'pdf', '2017-04-07', '14:00:00', 'Assignment looking at the use of Epidural and the implications of using it during labour', 'Epidural\r\nLabour', 0, 0, 0),
(3, 15181596, '2017-03-06 00:00:00', '0000-00-00', 'Research Paper', 'Comparison of different technologies used in the product design industry', 3000, 2792, 8, 'docx', '2017-04-21', '00:00:00', 'Research paper - researching the differences in technologies used in Ireland in different product design companies', 'Research paper\r\nTechnologies\r\nProduct design', 0, 0, 0),
(4, 15171798, '2017-03-06 00:00:00', '0000-00-00', 'Assignment', 'Restrictions encountered by computer users for people with dyslexia ', 3000, 2965, 9, 'docx', '2017-04-07', '17:00:00', 'This assignment looks at what tools can be made available to assist those with dyslexia, when using a computer or surfing the internet', 'Computers\r\nDisabilities\r\n', 0, 0, 0),
(5, 15196623, '2017-03-07 00:00:00', '0000-00-00', 'Assignment', 'How intensive courses can induce mental stress', 3000, 3105, 9, 'docx', '2017-04-12', '16:30:00', 'Assignment based on stress levels incurred through intensive study and how they can reduce stress', 'Mental health\r\nStudy', 0, 0, 0),
(6, 16121516, '2017-03-07 00:00:00', '0000-00-00', 'Assignment', 'Types of exercise that can reduce heart and lung problems', 2500, 2489, 6, 'pdf', '2017-04-13', '22:00:00', 'Looks at the benefits of exercise for people suffering from heart and lung problems', 'Heart and lung\r\nexercise', 0, 0, 0),
(7, 15186185, '2017-03-07 00:00:00', '0000-00-00', 'Assignment', 'Intellectual Disabilities in the third level sector - what benefits do people have by completing 3rd level', 3500, 3523, 10, 'doc', '2017-04-14', '17:30:00', 'A look at how learners with an intellectual disability can benefit from 3rd level education', 'Intellectual disability\r\nEducation', 0, 0, 0),
(8, 15171798, '2017-03-08 00:00:00', '0000-00-00', 'Assignment', 'Relational Databases - how they have modernized the way businesses interact with their customers', 2500, 2891, 6, 'doc', '2017-04-14', '18:00:00', 'Relational Databases are used by most businesses today and are often shared among companies - looks at the advantages of having access to databases', 'Central databases\r\nGaining customers\r\n', 0, 0, 0);
...
(16115224, 'Student', 'Bartkowski', 'Katarzyna', 'Midwifery', 'BSc', 1, '16115224@stumail.ul.ie', '', 0),
...
(16188222, 'Student', 'O\'Mahoney', 'David', 'Law and Accounting', 'BA', 1, '16188222@stumail.ul.ie', '7fb85d379020b75529d5f0141fc17371ec77c52014617', NULL),
(16188226, 'Student', 'McMahon', 'Siobhan', 'Nursing (Intellectual Disability)', 'BSc', 0, '16188223@stumail.ul.ie', '737f7efa70d755197f9dbdeb615c003c1eb2cf892f772', NULL),
(16188227, 'Student', 'O\'Brien', 'Frank', 'Law and Accounting', 'BA', 1, '16188227@stumail.ul.ie', '7fb85d379020b75529d5f0141fc17371ec77c52014617', NULL),
(16188228, 'Student', 'Smith', 'John', 'Law and Accounting', 'BA', 1, '16188228@stumail.ul.ie', '7fb85d379020b75529d5f0141fc17371ec77c52014617', NULL),
